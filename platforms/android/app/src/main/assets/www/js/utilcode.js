...
function sendQuestionShare(questionUrl, questionNo,shortQuestion) {
    ...
    var shareMsg = stringsDB.question + " " + questionNo + ": " + shortQuestion + "- " + stringsDB.islamqa_url + questionUrl + "\n\n" + stringsDB.download_from + " http://bit.ly/Islam-QA " + stringsDB.and_enter + " " + questionNo + " " + stringsDB.in_the_search_box;
...
function checkForUpdate() {
    ...
    var dUrl = "https://www.illumeacademy.com/projects/islamqa/index3.php?task=checkForUpdate&sync_no=" + syncId + "&platform=android";
